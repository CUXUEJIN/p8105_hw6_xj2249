...
reason is following: In my opinion, the sex and the gestational age of
the baby will definitly influence the birthweight, so include them
first. Then, mom’s weight gain during pregnancy and pre-pregnancy BMI
...
Therefore, the 95% confidence interval for log\_b0\_b1 is (1.965,2.064),
for r\_hat\_squared is (0.904,0.919).
